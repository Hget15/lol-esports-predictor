...
from feature_engineering_v2 import FEATURE_COLUMNS_V2 as FEATURE_COLUMNS, prepare_model_data
...
def load_features():
    ...
    df = pd.read_csv('data/engineered_features_v2.csv', low_memory=False)
...
if __name__ == "__main__":
    print("="*80)
    print("  LoL ESPORTS MATCH PREDICTION MODEL V2")
    print("  Enhanced Training Pipeline (Player-Level Features)")
    print("="*80)
    ...
    print("="*80)
    comparison_df = evaluate_and_plot(results, splits, feature_names, output_dir='output_v2')

    # Save models
    save_models(results, mu, sigma, feature_names, weights, output_dir='models_v2')
