...
from feature_engineering import FEATURE_COLUMNS, prepare_model_data
...
def load_features():
    ...
    df = pd.read_csv('data/engineered_features.csv', low_memory=False)
...
if __name__ == "__main__":
    print("="*80)
    print("  LoL ESPORTS MATCH PREDICTION MODEL")
    ...
    print("="*80)
    comparison_df = evaluate_and_plot(results, splits, feature_names)

    # Save models
    save_models(results, mu, sigma, feature_names, weights)
